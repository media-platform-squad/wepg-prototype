...
public class EsProgramQuery {
    ...
    private void indexProgramData(List<ProgramOrigin> programOrigins) throws RuntimeException {
    ...
    private BulkResponse bulkBatchData(List<ProgramOrigin> data) throws IOException {
